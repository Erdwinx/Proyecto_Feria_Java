...
<main class="layout wide">
    <section class="section-band">
        ...
        <p class="section-lead">Informacion oficial y novedades sobre accesos y actividades.</p>
        <div class="event-grid">
            <article class="event-card">
                ...
                <h3>Nuevos accesos rapidos</h3>
                <p>Se habilitan mas puntos de ingreso para un flujo mejor.</p>
            </article>
            <article class="event-card">
                <div class="event-meta">
                    <span>Movilidad</span>
                    <span class="event-badge">Guia</span>
                </div>
                <h3>Mapa de estacionamientos</h3>
                <p>Consulta las zonas disponibles antes de llegar.</p>
            </article>
            <article class="event-card">
                <div class="event-meta">
                    <span>Seguridad</span>
                ...
                <p>Revisa objetos permitidos y horarios de entrada.</p>
            </article>
        </div>
    </section>
</main>
